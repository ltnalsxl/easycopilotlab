...
{: .warning }
> **이 한계 때문에 오전 [S2 — Excel 분석 17단계](s02-excel-analysis) 가 만들어졌습니다.** 그쪽은 **Office Script + 토픽 + 흐름** 으로 우회하는 방법입니다. 즉, "채팅에 Excel 을 던지면 AI 가 알아서 분석" 은 강의 내내 **시도하지 말 것** 으로 일관됩니다.
