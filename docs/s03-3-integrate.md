...
> **S2 실습 ③** 의 핸즈온이 이 패턴의 기본형입니다. [S2 — 엑셀 업로드 활용 실습](s02-excel-analysis) 참조. (단순 자연어 분석이라면 **실습 ①** 의 "질문 노드 + Excel Table" 만으로도 충분하고, **실습 ②** 의 엑셀 커넥터+OData 필터도 명시적으로 소개하고 있다는 점도 기억해두세요.)
