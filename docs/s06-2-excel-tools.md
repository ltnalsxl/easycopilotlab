...
- 같은 Excel을 **도구(Tool)** 로 다루는 **3가지 길**을 비교
- ④ Excel 커넥터 / ⑤ CSV+AI / ⑥ Office Script — 무엇이 어떤 상황에 맞는지
- Excel 졸업: **⑦ SP 리스트 / ⑧ Dataverse**의 기준
- 최종 의사결정 트리 완성

{: .highlight }
> S6 매트릭스의 "정형 × 도구 (②)" 칸을 Excel로 끝까지 채워보는 자리입니다.
...
{: .note }
> 기본과정 M12에서 **행 추가**를 배웠습니다. 같은 커넥터로 **행 조회**도 할 수 있습니다.
...
| | S2 (Excel 첨부 → AI 분석) | 이 실습 ③ (Excel → 에이전트) |
|:--|:------------------|:----------------------|
| Office Script 역할 | **읽기/쓰기** (테이블 조작) | **읽기** (필터링+반환) |
