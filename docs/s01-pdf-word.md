...
![실습 ①→④ 그라디언트 인포그래픽](../assets/images/s03/03_세션1_인포_4단계.png)
...
> **시간 배분 (60분)**: 도입 5 / 실습① 8 / 실습② 15 / 실습③ 22 / 실습④ 8 / 마무리 2
...
| 페이지 | 시간 | 역할 | 한 줄로 |
|:---|:---|:---|:---|
| [실습① — Markdown + 빌트인](s01-1-markdown) | 8분 | 🟢 직접 | 흐름 없이 5분에 만드는 가장 쉬운 경로 |
| [실습② — HTML 인라인 CSS](s01-2-html) | 15분 | 🟢 직접 | 인라인 CSS로 한국 비즈니스 양식을 입힌다 |
| [실습③-A — 백엔드: 템플릿 + 흐름](s01-3a-template) | 14분 | 🟡 따라보기 | Word 템플릿 + Power Automate 흐름로 백엔드 구축 |
| [실습③-B — 에이전트 연결](s01-3b-agent) | 8분 | 🟡 따라보기 | 흐름을 에이전트 도구로 등록·테스트 |
| [실습④-A — 백엔드: 템플릿 + 프롬프트 + 흐름](s01-4a-aibuilder) | 5분 | 🟡 따라보기 | AI 빌더 프롬프트가 추출+채우기를 한 번에 처리 |
| [실습④-B — 에이전트 연결](s01-4b-agent) | 3분 | 🟡 따라보기 | 흐름을 에이전트 도구로 등록·테스트 |
