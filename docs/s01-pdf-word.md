...
| [실습② — HTML 인라인 CSS](s01-2-html) | 11분 | 🟢 직접 | 인라인 CSS로 한국 비지니스 양식을 입힌다 |
| [실습③-A — 백엔드: 템플릿 + 흐름](s01-3a-template) | 10분 | 🟡 따라보기 | Word 템플릿 + Power Automate 흐름로 백엔드 구축 |
| [실습③-B — 에이전트 연결](s01-3b-agent) | 8분 | 🟡 따라보기 | 흐름을 에이전트 도구로 등록·테스트 |
| [실습④-A — 백엔드: 템플릿 + 프롬프트 + 흐름](s01-4a-aibuilder) | 4분 | 🟡 따라보기 | AI 빌더 프롬프트가 추출+채우기를 한 번에 처리 |
| [실습④-B — 에이전트 연결](s01-4b-agent) | 2분 | 🟡 따라보기 | 흐름을 에이전트 도구로 등록·테스트 |
