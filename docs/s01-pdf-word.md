...
> **시간 배분 (60분)**: 도입 5 / Tier 1 8 / Tier 2 15 / Tier 3 22 / Tier 4 4 / Tier 5 4 / 마무리 2

---

## 5. 다음 페이지로

이제 5-Tier를 차례대로 실습합니다. 각 단계의 마지막에 "이게 부족해서 다음 단계로 간다"는 동기를 꾭 짚으면서 진행하세요.
...
| [실습④ — Tier 4: AI 빌더 문서 출력](s01-4-tier4-aibuilder) | 4분 | 🟡 따라보기 | AI 빌더 프롬프트가 추출+채우기를 한 번에 처리 |
| [실습⑤ — Tier 5: 멀티모달 + 결정적 폼](s01-5-tier5-multimodal) | 4분 | 🟡 따라보기 | 입구를 토픽 질문 노드로, 프롬프트를 멀티모달로 확장 |
