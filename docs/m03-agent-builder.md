...
{: .important }
> 📌 이 실습은 별도 페이지에서 진행합니다.  
> [실습 ②: 솔루션 만들기](m03-2-open-in-studio)를 완료하고 돌아오세요.
...
{: .important }
> 📌 이 실습은 별도 페이지에서 진행합니다.  
> [실습 ③: Copilot Studio로 가져오기](m03-3-studio-new-agent)를 완료하고 돌아오세요.
...
4. 솔루션을 먼저 만들고, 에이전트 빌더에서 Copilot Studio로 복사한 뒤 **한국어 + 솔루션**을 설정
...
| 에이전트 빌더에서 가져온 에이전트는 왜 안 쓰나요? | 실습 ③에서 가져온 에이전트에 한국어와 솔루션을 설정하여 사용합니다. |
