...
![OneDrive — Excel 통합 문서 만들기](../assets/images/m12/image.png)
...
![헤더 행 입력 — 시간, 사용자, 질문, 답변](../assets/images/m12/image2.png)

### 3. 표(Table)로 변환 — 범위 선택 & 삽입

**A1:D2** 영역을 드래그하여 선택한 뒤, 상단 **"삽입"** 탭 → **"테이블"** 클릭

![삽입 탭 — 테이블 버튼](../assets/images/m12/image3.png)
...
![테이블 만들기 대화상자](../assets/images/m12/image4.png)
...
![테이블 생성 완료 — 표 디자인 탭 확인](../assets/images/m12/image5.png)
