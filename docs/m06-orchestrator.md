...
![M6 오케스트레이터 — 자동변속 엔진](../assets/images/m06/hero.png)
...
| GPT-5 Chat | 대부분 작업에 적합 | ✅ 오늘 실습 엔진 |
...
{: .tip }
> 이 모듈에서는 **기본값(GPT-4.1)**이 아닌 **GPT-5 Chat**으로 시작합니다. 실습 ①에서 모델을 변경하여 결과 차이를 직접 체험해보세요.  
---
...
> [실습 ①: 모델 변경 + 비교](m06-1-model-compare)를 완료하고 돌아오세요.
...
{: .important }
> 📌 이 실습은 별도 페이지에서 진행합니다.  
> [실습 ②: 에이전트 설정 변경](m06-2-agent-settings)을 완료하고 돌아오세요.
...
다음 모듈: [M7. 2요소 지침](m07-instructions)
