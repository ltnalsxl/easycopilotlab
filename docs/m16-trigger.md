...
![M15 트리거 — 잠든 AI가 이벤트로 깨어난다](../assets/images/m16/hero.png)
...
>
> 👉 [실습②: 트리거 추가하기](m16-2-add-trigger)
>
> 👉 [실습③: 트리거 워크플로우 업데이트](m16-3-trigger-workflow)
>
> 👉 [실습④: 트리거 결과 테스트](m16-4-trigger-result)
