...
[실습③-A](s01-3a-template) 에서 만든 Word 템플릿과 흐름(`meetingnote_template`)을 에이전트가 부를 수 있게 지침·도구로 연결하고, 실제 회의록 PDF 로 동작을 확인합니다.
...
![에이전트 이름 지정 — S1실습3 HOL → 만들기](../assets/images/s01-3/036_click.png)
...
[실습④ — AI 빌더 문서 출력](s01-4a-aibuilder)
