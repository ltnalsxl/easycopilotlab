...
# 세션 2 — 데이터 분석: Excel 첨부부터 AI 요약까지
{: .no_toc }
...
세션 1에서 우리는 흥미로운 사실을 확인했습니다. **Copilot Studio의 오케스트레이터는 채팅창에 첨부된 PDF·Word·이미지 같은 일반 문서를 알아서 받아 잘 처리**합니다. 별도 토픽이나 흐름 없이도 "이거 요약해줘"라고만 하면 동작했죠.
