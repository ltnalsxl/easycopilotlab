...
![슈퍼호스트에이전트 도구 탭에서 도구 추가 버튼 클릭](../assets/images/s08/image.png)
...
![MCP 서버 추가 — 서버 이름, 설명, URL 입력 후 만들기 클릭](../assets/images/s08/image2.png)

## Step 3 — 연결 생성

커넥터가 생성되면 **연결되지 않음** 상태가 표시됩니다.

![Microsoft Learn 커넥터 생성 완료 — 연결되지 않음 상태](../assets/images/s08/image3.png)

연결 드롭다운을 클릭하고 **새 연결 만들기**를 선택합니다.

![연결 드롭다운에서 새 연결 만들기 선택](../assets/images/s08/image4.png)

**Microsoft Learn에 연결** 팝업에서 **만들기**를 클릭합니다.

![Microsoft Learn에 연결 팝업 — 만들기 클릭](../assets/images/s08/image5.png)

연결이 완료되면 녹색 체크가 표시됩니다. **추가 및 구성**을 클릭합니다.

![연결 완료 녹색 체크 확인 후 추가 및 구성 클릭](../assets/images/s08/image6.png)

## Step 4 — 도구 확인 및 저장

MCP 서버에서 제공하는 도구 목록이 표시됩니다. URL 하나만 입력했는데 **3개의 도구**가 자동으로 연결된 것을 확인하세요.

![Microsoft Learn MCP 도구 목록 — docs_search, code_sample_search, docs_fetch](../assets/images/s08/image7.png)

**세부 정보** 탭에서 추가 세부 정보를 펼쳐 **사용할 자격 증명**이 "작성자가 제공한 자격 증명"으로 설정되어 있는지 확인합니다.

![세부 정보 — 추가 세부 정보 및 작성자가 제공한 자격 증명 확인](../assets/images/s08/image8.png)

오른쪽 상단 **저장**을 클릭합니다.

![세부 정보 확인 후 저장 클릭](../assets/images/s08/image9.png)
...
![지침에 기술 관련 질문은 microsoft_docs_search를 사용합니다 규칙 추가](../assets/images/s08/image10.png)
...
![테스트 — Microsoft Learn MCP 호출 후 microsoft_docs_search로 기술문서 검색 응답](../assets/images/s08/image11.png)

---

실습을 완료했으면 [S8 본문으로 돌아가세요](s08-mcp).
