...
| 실습 | 주제 | 시간 |
|:----|:-----|:----|
| [실습 ① — 사용자 정의 솔루션 만들기](s10-1-solution) | 솔루션 생성·게시자·구성요소 추가 | 15분 |
| [실습 ② — 환경 변수 적용하기](s10-2-env-variable) | 변수 정의·흐름·토픽에서 참조 | 15분 |
...
먼저 [실습 ① — 사용자 정의 솔루션 만들기](s10-1-solution)로 시작합니다.
