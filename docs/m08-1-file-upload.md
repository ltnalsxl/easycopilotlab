...
| 파일명 | 내용 | 형태 | 다운로드 |
|:-------|:-----|:-----|:---------|
| FAQ.docx | 자주 묻는 질문·답변 | Q&A 구조화 | [📥 다운로드](../assets/files/FAQ.docx) |
| 담당자정보.docx | 부서별 담당자 이름·연락처 | 표 형식 | [📥 다운로드](../assets/files/담당자정보.docx) |
| 복리후생_안내.docx | 복지포인트·건강검진·경조사 | 서술형 | [📥 다운로드](../assets/files/복리후생_안내.docx) |
| 경비처리_가이드.docx | 출장·법인카드·청구 절차 | 서술형 | [📥 다운로드](../assets/files/경비처리_가이드.docx) |
| 휴가_근태_가이드.docx | 연차·반차·병가·특별휴가 | 서술형 | [📥 다운로드](../assets/files/휴가_근태_가이드.docx) |

![업로드할 문서 5종 파일 목록](../assets/images/m08/image.png)
...
![지식 탭 — "참조 자료 원본 추가" 화면](../assets/images/m08/image2.png)

**② 파일 업로드 영역 (드래그&드롭)**

![참조 자료 추가 — 파일 업로드 드래그&드롭 영역](../assets/images/m08/image3.png)

**③ 5개 파일 선택 완료 → "에이전트에 추가" 클릭**

![파일 업로드 — 5개 파일 선택 후 "에이전트에 추가" 버튼 클릭](../assets/images/m08/image4.png)

**④ 참조 자료 상태 — "진행 중" 표시**

![참조 자료 목록 — 상태 "진행 중"](../assets/images/m08/image5.png)

**⑤ 모든 파일 "준비" 완료 확인**

![참조 자료 목록 — 모두 "준비" 완료](../assets/images/m08/image6.png)
...
![테스트 — "경비처리 담당자 누구야?" 질문에 담당자정보.docx 기반 답변](../assets/images/m08/image7.png)
...
실습을 완료했으면 [M8 본문으로 돌아가세요](m08-knowledge).
