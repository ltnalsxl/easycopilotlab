...
{: .highlight }
> S4에서는 AI가 **이미지를 보고** 데이터를 뽑았고, S5에서는 AI가 **문서를 읽고** 보고서를 만듭니다. 입력과 출력이 모두 **파일**인 것이 핵심입니다.
...
| 유형 | 입력 | 출력 | 사용한 모듈 |
|:-----|:-----|:-----|:-----------|
| 텍스트 프롬프트 | 텍스트 | 텍스트 | M13(기본), S5 |
| 멀티모달 프롬프트 | 텍스트 + 이미지 | 텍스트 | **S4** |
| 코드 인터프리터 | 데이터 | 텍스트 + 차트 | — |
| **Word 아웃풋** | 텍스트 | **.docx 파일** | **S5** |
