...
| 시간 | 소요 | 수강생 역할 |
|:-----|:-----|:-----------|
| 10:50 | 8분 (Tier 4 본문 4분 + Tier 5 변형 4분) | 🟡 따라보기 |
...
> **S3 마무리** — "임의 양식 PDF → 회사 표준 Word" 라는 한 시나리오를 5번 다르게 만들었습니다. 이어 [S9 — 12 패턴 카탈로그](s09-design-patterns) 에서는 앞에서 만진 도구군 (토픽 + 흐름 + Office Script + AI 프롬프트 + AI 빌더) 을 12개 설계 패턴으로 묶어 의사결정 구조를 만들어둡니다.
