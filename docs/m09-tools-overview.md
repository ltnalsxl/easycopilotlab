...
![M8 도구들 — 도구 선반에서 골라 쓰기](../assets/images/m09/hero.png)
...
| **커넥터** | Microsoft 365 앱과 직접 연결 | M12 |
| **에이전트 흐름** | Power Automate로 복잡한 자동화 | M13 |
| **AI 프롬프트** | Flow 안에서 AI 로직 실행 | M14 |
| **멀티에이전트** | 다른 에이전트를 도구로 호출 | M15 |
...
![오케스트레이터의 도구 채택 흐름 — 사용자 입력 → 판단 → 지식/토픽/흐름/에이전트](../assets/images/m09/tool-selection.png)
...
3. M10~M17에서 도구를 하나씩 직접 만든다

---

다음 모듈: [M10. 도구 — 토픽과 변수](m10-topic-variables)
