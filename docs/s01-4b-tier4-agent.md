---
title: "실습④-B — Tier 4 에이전트: 도구 + 테스트"
parent: "S1. 문서 업로드 활용 실습"
grand_parent: "📗 심화과정"
nav_order: 6
---

# 실습 ④-B: Tier 4 에이전트 — 도구 + 테스트
{: .no_toc }
...
[실습④-A](s01-4a-tier4-aibuilder) 에서 만든 흐름(`meetingnote_AI`)을 에이전트에 도구로 등록하고, 회의록 PDF 를 채팅에 첨부해 다운로드 링크를 받는 데까지 확인합니다.
...
에이전트 `Tier4 HOL` 의 도구 탭에서 조금 전 만들어 저장한 `meetingnote_AI` 흐름을 골라 추가하고, 입력은 흐름 트리거와 맞추어 `contentBytes (File)` · `name (String)` 을 확인합니다.
