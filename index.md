...
이 사이트는 **2일 과정**으로, 기본과정과 심화과정으로 나뉩니다.
...
| 모듈 수 | S2~S5 · S7~S11 (8개 모듈 + 마무리) |
| 핵심 내용 | Excel 분석 → 문서 자동화 5-Tier → 12 패턴 카탈로그 → 외부 연결(MCP·커스텀 커넥터) → 데이터·UX·운영 |
...
| | 📘 기본과정 | 📗 심화과정 |
|:--|:--------|:--------|
| 문서 자동화 | — | **5-Tier 그라디언트** (빌트인 → HTML → 흐름 → AI 빌더 → 멀티모달) |
